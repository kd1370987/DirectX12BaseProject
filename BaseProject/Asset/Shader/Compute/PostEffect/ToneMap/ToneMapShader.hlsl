...
//
//==========================================================================================
#include "../../../Common/CB/CBToneMapOption.hlsli"

// ルートシグネチャ
//   param0 : CBV (b14)     … トーンマップ設定
//   param1 : SRV テーブル (t0) … 入力カラー(AfterTAAColor / HDR)
//   param2 : UAV テーブル (u0) … 出力カラー(FinalColor / LDR)
#define TONEMAP_ROOT_SIG \
"RootFlags(0)," \
RS_TONEMAP_OPTION_CB "," \
