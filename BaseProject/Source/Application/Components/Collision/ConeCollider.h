...
template<>
struct Engine::ECS::ComponentTraits<ConeColliderComponent>
{
	static void Archive(Engine::Persistence::Archive& a_ar, void* a_pData)
	{
		ConeColliderComponent& _comp = Engine::Editor::GetValue<ConeColliderComponent>(a_pData);
	...
	{
		ConeColliderComponent& _comp = Engine::Editor::GetValue<ConeColliderComponent>(a_context.pData);
