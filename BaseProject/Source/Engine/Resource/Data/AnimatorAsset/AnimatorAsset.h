...
namespace Engine::Resource
{
	...
	public:
		...
		//----------------------------------------------------------------------------------
		void SetFloatParam(StateMachineInstance& a_instance, UINT a_hash, const std::string& a_name, float a_value)
		{
			m_graph.EnsureParameter(a_hash, a_name, StateGraph::EParamType::Float);
			a_instance.SetFloat(a_hash, a_value);
		}
		void SetIntParam(StateMachineInstance& a_instance, UINT a_hash, const std::string& a_name, int a_value)
		{
			m_graph.EnsureParameter(a_hash, a_name, StateGraph::EParamType::Int);
			a_instance.SetInt(a_hash, a_value);
		}
		void SetBoolParam(StateMachineInstance& a_instance, UINT a_hash, const std::string& a_name, bool a_value)
		{
