...
namespace Engine::Graphics
{
	void AddGBufferPass(D3D12::PipelineStateManager* a_pPSOManager, RenderPassRegistry* a_pRegistry, const EDrawPhase& a_phase)
	{
		...
		auto* _pBlolb = _rpBuilder.SetVS(_sPso, "Asset/Shader/Source/GBufferShader/GBufferVS.cso", D3D12::Input::StaticLayout);
		...
		_spPassData->pRootSig = _rpBuilder.SetRootSignature(a_pPSOManager, _pBlolb);
