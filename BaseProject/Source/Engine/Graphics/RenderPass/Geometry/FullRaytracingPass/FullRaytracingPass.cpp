...
namespace Engine::Graphics
{
	void AddFullRaytracingPass(D3D12::PipelineStateManager* a_pPSOManager, RenderPassRegistry* a_pRegistry, const EDrawPhase& a_phase)
	{
		...
		_psoInit.shaderPass = "Asset/Shader/Source/Raytracing/FullRaytracing/Raytracing.hlsl";
		...
		(GraphicsEngine* a_pGE, RenderContext* a_pCtx, const RGPassResources& a_res)
		{
			...
			_spPassData->shaderTable.CommitInstanceBindLess(_instanceVec, a_pCtx,_winOp.windowWidth,_winOp.windowHeight);
