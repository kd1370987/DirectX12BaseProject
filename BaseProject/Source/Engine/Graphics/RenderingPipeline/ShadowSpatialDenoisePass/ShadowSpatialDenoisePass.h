...
{
	//======================================================================================
	// ShadowSpatialDenoisePass
	//
	// レイトレ影のノイズを、エッジを保ちながら空間方向にならす。
	//
	...
	//======================================================================================
	class ShadowSpatialDenoisePass : public Pass
	{
	public:
		~ShadowSpatialDenoisePass() override = default;
	...
	private:
		...
		std::string m_resourceName = "DenoisedShadow";
